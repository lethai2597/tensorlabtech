...
export function PartnershipHeroSection() {
  ...
  const itemVariants = {
    ...
    show: shouldReduceMotion
      ? { opacity: 1, y: 0 }
      : { opacity: 1, y: 0, transition: { duration: 0.6, ease: easeOutQuart } },
  } as const;
  ...
  return (
    <motion.section
      ...
      className="relative overflow-hidden bg-linear-to-b from-surface via-surface to-background pt-36 pb-20 md:pt-48 md:pb-28"
    >
      {/* Gradient backdrop */}
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(800px circle at 20% 10%, color-mix(in srgb, var(--color-primary) 20%, transparent) 0%, transparent 60%),
            radial-gradient(700px circle at 85% 30%, color-mix(in srgb, var(--color-info) 16%, transparent) 0%, transparent 58%)
          `,
        }}
      />
      <div
        ...
        >
          ...
          >
            <Link href="/contact?type=product">
              ...
              >
                {t("hero.ctaProduct")} <ArrowRight className="size-4" />
              </Button>
            </Link>
            <Link href="/contact?type=outsource">
              ...
              >
                {t("hero.ctaOutsource")} <ChevronRight className="size-4" />
              </Button>
            </Link>
          </motion.div>
        </motion.div>
