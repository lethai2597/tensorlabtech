                ...
                <div className="space-y-6">
                  <div className="rounded-2xl border border-border bg-background overflow-hidden">
                    <div className="relative aspect-video">
                      <div
                        aria-hidden="true"
                        className="absolute inset-0 bg-linear-to-br from-primary/18 via-transparent to-primary/8"
                      />
                      <div
                        aria-hidden="true"
                        className="absolute -top-16 -right-20 size-64 rounded-full bg-primary/10 blur-3xl"
                      />
                      <div
                        aria-hidden="true"
                        className="absolute -bottom-24 -left-24 size-72 rounded-full bg-primary/8 blur-3xl"
                      />

                      <div className="relative h-full w-full p-6 flex items-end justify-between gap-4">
                        <div className="flex items-center gap-3">
                          <div className="size-11 rounded-2xl bg-background/70 border border-border flex items-center justify-center text-primary">
